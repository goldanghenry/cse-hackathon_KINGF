  ...
  198: function (t, e, i) {
    ...
    ;(function (e, n, o, a) {
      ...
      !(function () {
        ...
        } else if (((util.nextTick = e.nextTick), "function" == typeof n))
          util.setImmediate = n
              ...
              (e._addTouchEventListeners = function t() {
                ...
                if (this._touchSupported) {
                  var i = function t(i) {
                      if (
                        e._pointerEvent &&
                        st[i.originalEvent.pointerType.toUpperCase()]
                      )
            ...
            o.ajax({
              ...
              .done(function (data, t) {
                if (
                  ...
                  if ((FormMessage.showSuccess(form), s))
          ...
          ci = function (t, e, o, a) {
            ...
            if (l && u && void 0 !== u.x) {
              ...
              ;(function () {
                var e = c,
                  a =
                    !n.currItem.src || n.currItem.loadError || s.showHideOpacity
                if (t.miniImg)
            ...
            (i.prototype.off = function (t, e) {
              ...
              if (a && this.handlers[a] && o)
                ...
                for (var u in this.handlers)
                  i(s, this.handlers[u][o] || [], e), (this.handlers[u][o] = [])
